...
(function (BP3D) {
    ...
    (function (Three) {
        ...
        (function (Loaders) {
                ...
                var promiseObj = {
                    then: function (onSuccess, onError) {
                        ...
                        if (typeof THREE === 'undefined') {
                            if (onError)
                                onError(new Error('THREE.js not loaded'));
                            return;
                        }
                        ...
                        if (onError)
                            onError(new Error('No GLTF loader available. Ensure GLTFLoader.js is loaded or ModelLoader is available.'));
                    },
            ...
            Loaders.loadGLTF = loadGLTF;
            /**
             * Process loaded GLTF object: set shadows, scale, and recenter
             */
            function processGLTFObject(object, scaleInches, castShadow, receiveShadow) {
                if (!object)
                    return;
            ...
            Loaders.isGLTFFile = isGLTFFile;
        })(Loaders = Three.Loaders || (Three.Loaders = {}));
...
(function (BP3D) {
    ...
    (function (Model) {
        ...
        var Scene = (function () {
            ...
            Scene.prototype.validateGeometry = function (geometry) {
                if (!geometry) {
            ...
            Scene.prototype.createFallbackItem = function (itemType, metadata, position, rotation, scale, fixed) {
                ...
                try {
                    ...
                    var item = new (BP3D.Items.Factory.getClass(itemType))(this.model, metadata, fallbackGeometry, fallbackMaterial, position, rotation, scale);
            ...
            Scene.prototype.addItem = function (itemType, fileName, metadata, position, rotation, scale, fixed) {
                ...
                if (BP3D.Three.Loaders.isGLTFFile(fileName)) {
                    // Handle GLTF loading
                    var gltfOptions = {
                        castShadow: true,
                        receiveShadow: true
                    ...
                    BP3D.Three.Loaders.loadGLTF(fileName, gltfOptions)
                        ...
                        try {
                            ...
                            var item = new (BP3D.Items.Factory.getClass(itemType))(scope.model, metadata, wrapperGeometry, wrapperMaterial, position, rotation, scale);
                            // Validate the GLTF object before adding
                            var hasValidGeometry = false;
                            object3d.traverse(function (child) {
                                if (child instanceof THREE.Mesh && child.geometry) {
                                    var geom = child.geometry; // Cast to any for Three.js v0.69 compatibility
    ...
    (function (Floorplanner_1) {
        ...
        var Floorplanner = (function () {
            ...
            function Floorplanner(canvas, floorplan) {
                ...
                this.canvasElement.on('touchcancel', function (event) {
                    event.preventDefault();
                    scope.mouseup();
                    scope.mouseleave();
                });
    ...
    (function (Three) {
        Three.Main = function (model, element, canvasElement, opts) {
            ...
            this.cleanupScene = function () {
                ...
                mainScene.children.forEach(function (child, index) {
                    if (!child) {
                    ...
                    if (child.material) {
                        ...
                        if (mat.materials && Array.isArray(mat.materials)) {
                            var hasNullMaterial = mat.materials.some(function (m) { return !m; });
                            if (hasNullMaterial) {
            ...
            function isolateProblematicObject(mainScene) {
                ...
                for (var i = 0; i < mainScene.children.length; i++) {
                    ...
                    if (problematicObjectsRemoved.indexOf(testObject.uuid) !== -1)
                        continue;
